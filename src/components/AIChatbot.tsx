...
Pode me perguntar sobre localização, preço, características ou qualquer outra informação que precise. Como posso ajudar você hoje?`;
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-6 right-6 w-80 sm:w-96 h-[500px] shadow-2xl z-50 flex flex-col bg-white/95 backdrop-blur-sm border-2 border-blue-200 overflow-hidden">
              ...
              {messages.map((message) => (
                ...
                >
                  <div className={`flex items-start space-x-2 max-w-[75%] ${message.isUser ? 'flex-row-reverse space-x-reverse' : ''}`}>
                    ...
                    <div
                      className={`px-3 py-2 rounded-lg text-sm leading-relaxed max-w-full ${
                        message.isUser
